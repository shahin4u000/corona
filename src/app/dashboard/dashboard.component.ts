import { AllCountries } from './../api/all-countries';
...
export class DashboardComponent implements OnInit {
  ...
  getAll() {
    this.coronaNews.coronaAll().subscribe((results: All) => {
      ...
      console.log("DashboardComponent -> constructor -> result", `this.lastUpdate - $new Date()`);
    });
  }
